...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description }) => (
  <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm hover:shadow-md transition-all border border-slate-100 dark:border-slate-700 group h-full">
    <div className="w-14 h-14 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center text-orange-600 dark:text-orange-500 mb-6 group-hover:bg-orange-600 group-hover:text-white transition-colors">
      {icon}
    </div>
...
const Services: React.FC = () => {
  const servicesList = [
    ...
    },
    {
      ...
      description: "Профессиональная внутренняя и внешняя отделка любых поверхностей. Штукатурка, покраска, декор."
    },
    {
      icon: <Wrench size={28} />,
      title: "Инженерные системы",
      description: "Проектирование и монтаж систем отопления, водоснабжения, канализации и электросетей."
    },
    {
      icon: <Truck size={28} />,
      title: "Снабжение и логистика",
      description: "Комплектация объектов строительными материалами по оптовым ценам с доставкой на объект."
    }
  ];
    ...
    <section id="services" className="py-24 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">Наши Услуги</h2>
...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ name, role, content, image }) => (
  <div className="bg-slate-50 dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 transition-colors">
    ...
    <p className="text-slate-700 dark:text-slate-300 mb-6 italic">"{content}"</p>
...
const AIConsultant: React.FC = () => {
  ...
  // Use a ref for the container to control scroll position
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col h-[500px] transition-colors">
      ...
      <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2 border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 placeholder-slate-400"
          />
          <button 
            onClick={handleSend}
...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      {/* Header */}
      <header className="fixed w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm z-50 border-b border-slate-100 dark:border-slate-800 transition-colors duration-300">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Строй<span className="text-orange-600">Мастер</span></span>
            </div>

            {/* Desktop Navigation */}
            <nav className="hidden md:flex items-center gap-8">
              <a href="#services" className="text-slate-600 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-500 font-medium transition-colors">Услуги</a>
              <a href="#projects" className="text-slate-600 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-500 font-medium transition-colors">Проекты</a>
              <a href="#about" className="text-slate-600 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-500 font-medium transition-colors">О нас</a>
              <a href="#contact" className="text-slate-600 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-500 font-medium transition-colors">Контакты</a>
            </nav>
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <div className="flex flex-col items-end mr-2">
                <span className="text-xs text-slate-500 dark:text-slate-400">Есть вопросы?</span>
                <span className="font-bold text-slate-900 dark:text-white">+7 (999) 123-45-67</span>
              </div>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 absolute w-full left-0 top-20 shadow-xl py-4 px-6 flex flex-col gap-4">
            <a href="#services" className="text-lg font-medium text-slate-800 dark:text-slate-200" onClick={() => setIsMenuOpen(false)}>Услуги</a>
            <a href="#projects" className="text-lg font-medium text-slate-800 dark:text-slate-200" onClick={() => setIsMenuOpen(false)}>Проекты</a>
            <a href="#about" className="text-lg font-medium text-slate-800 dark:text-slate-200" onClick={() => setIsMenuOpen(false)}>О нас</a>
            <a href="#contact" className="text-lg font-medium text-slate-800 dark:text-slate-200" onClick={() => setIsMenuOpen(false)}>Контакты</a>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">Реализованные Проекты</h2>
              <p className="text-slate-600 dark:text-slate-300 text-lg">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 relative">
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-orange-100 dark:bg-orange-900/30 rounded-full z-0" />
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-slate-100 dark:bg-slate-800 rounded-full z-0" />
              <img 
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-lg">Фиксированная смета</h4>
                    <p className="text-slate-500 dark:text-slate-400">Цена не меняется в процессе работ. Все прописано в договоре.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-lg">Соблюдение сроков</h4>
                    <p className="text-slate-500 dark:text-slate-400">Мы ценим ваше время и сдаем объекты точно в срок, без задержек.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-lg">Гарантия 5 лет</h4>
                    <p className="text-slate-500 dark:text-slate-400">Мы уверены в качестве наших работ и даем расширенную гарантию.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">Отзывы Клиентов</h2>
          </div>
      ...
      <section id="contact" className="py-24 bg-white dark:bg-slate-900 relative transition-colors duration-300">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
            ...
            {/* Contact Form & Info */}
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-6">Свяжитесь с нами</h2>
              ...
              <div className="flex flex-col gap-6 mb-10">
                <div className="flex items-center gap-4 text-slate-700 dark:text-slate-300">
                  <div className="w-10 h-10 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center text-orange-600">
                    <Phone size={20} />
                  </div>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-2 gap-4">
                  <input type="text" placeholder="Ваше имя" className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors placeholder-slate-400" />
                  <input type="tel" placeholder="Телефон" className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors placeholder-slate-400" />
                </div>
                <input type="email" placeholder="Email" className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors placeholder-slate-400" />
                <textarea placeholder="Опишите ваш проект..." rows={4} className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors placeholder-slate-400"></textarea>
                <button type="submit" className="w-full bg-slate-900 dark:bg-white dark:text-slate-900 text-white font-bold py-4 rounded-lg hover:bg-slate-800 dark:hover:bg-slate-200 transition-colors">
                  Отправить заявку
                </button>
              </form>
            </div>
            ...
            <div className="flex flex-col justify-center">
              <div className="mb-4">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Мгновенная консультация</h3>
